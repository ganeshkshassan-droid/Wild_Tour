...
<head>
    ...
    <meta name="description" content="Explore the grace and beauty of deer through this stunning wildlife gallery." />
    <title>Deer Gallery | Wildlife Tourism</title>
    ...
    <!-- Use the same styles as elephant.jsp above -->
    <style>
        /* Copy all styles from elephant.jsp - they are identical */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero-section { position: relative; height: 75vh; min-height: 500px; display: flex; align-items: center; justify-content: center; text-align: center; overflow: hidden; background: linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.6)), url('https://static.toiimg.com/thumb/msid-100970583,width-1070,height-580,imgsize-73274,resizemode-75,overlay-toi_sw,pt-32,y_pad-40/photo.jpg') center/cover no-repeat; margin-top: 0; }
...
<section class="page-header">
    <div class="container">
        <div class="header-content" data-aos="fade-up">
            ...
            <h1>Deer <span>Gallery</span></h1>
            <p>Explore the grace and beauty of deer in their natural habitat</p>
        </div>
    </div>
</section>
...
<section class="hero-section">
    <div class="hero-content">
        ...
        <h1>Spotted <span>Elegance</span></h1>
...
<section class="gallery-section" id="gallery">
    <div class="container">
        <div class="section-header" data-aos="fade-up">
            ...
            <h2>Deer <span>Gallery</span></h2>
            <p>Explore the stunning collection of deer photographs from the wild</p>
        </div>

        <div class="gallery-grid">
            <!-- Gallery Card 1 - Curious Fawn -->
            <div class="gallery-card" data-bs-toggle="modal" data-bs-target="#photoModal" 
                 data-bs-img="https://static.vecteezy.com/system/resources/previews/054/941/432/non_2x/deer-fawn-with-singed-coat-nestled-in-recovery-enclosure-looking-curious-and-vulnerable-photo.jpg"
                 data-bs-title="Curious Fawn"
                 data-bs-desc="A young deer fawn exploring its surroundings"
                 data-bs-sub="Young and adventurous"
                 data-bs-index="1"
                 data-bs-total="4">
                <img loading="lazy" src="https://static.vecteezy.com/system/resources/previews/054/941/432/non_2x/deer-fawn-with-singed-coat-nestled-in-recovery-enclosure-looking-curious-and-vulnerable-photo.jpg" alt="Curious Fawn"/>
                <div class="card-overlay">
                    <span class="caption">Curious Fawn</span>
                    <span class="sub-caption">Young and adventurous</span>
                    <span class="view-icon"><i class="fa-solid fa-expand"></i></span>
                </div>
            </div>

            <!-- Gallery Card 2 - Spotted in the Wild -->
            <div class="gallery-card" data-bs-toggle="modal" data-bs-target="#photoModal" 
                 data-bs-img="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhgdGP_8TK5FuyO4mikZb4GVLpI2ySye5bY9XV7-LmyghpsrqPRlzsi2j2YknnSFwcb6HrptS8DIgood_7quYGt4XwC8yaO3dv1u_pEWEVLtRVskKus07Nop0k26cfkges2wTsKtH6wkrE/s800/IMG_2723.JPG"
                 data-bs-title="Spotted in the Wild"
                 data-bs-desc="A beautiful deer with striking spots in its natural habitat"
                 data-bs-sub="Beautiful markings"
                 data-bs-index="2"
                 data-bs-total="4">
                <img loading="lazy" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhgdGP_8TK5FuyO4mikZb4GVLpI2ySye5bY9XV7-LmyghpsrqPRlzsi2j2YknnSFwcb6HrptS8DIgood_7quYGt4XwC8yaO3dv1u_pEWEVLtRVskKus07Nop0k26cfkges2wTsKtH6wkrE/s800/IMG_2723.JPG" alt="Spotted Deer"/>
                <div class="card-overlay">
                    <span class="caption">Spotted in the Wild</span>
                    <span class="sub-caption">Beautiful markings</span>
                    <span class="view-icon"><i class="fa-solid fa-expand"></i></span>
                </div>
            </div>

            <!-- Gallery Card 3 - Stag in the Mist -->
            <div class="gallery-card" data-bs-toggle="modal" data-bs-target="#photoModal" 
                 data-bs-img="https://media.istockphoto.com/id/492988518/photo/red-deer-stag-in-the-early-morning-mist.jpg?s=612x612&w=0&k=20&c=tfF_Mo65vGfjKPYolrPORSytd7uLwizKxih2YDNvXaI="
                 data-bs-title="Stag in the Mist"
                 data-bs-desc="A majestic red deer stag emerging through the morning mist"
                 data-bs-sub="Majestic and mysterious"
                 data-bs-index="3"
                 data-bs-total="4">
                <img loading="lazy" src="https://media.istockphoto.com/id/492988518/photo/red-deer-stag-in-the-early-morning-mist.jpg?s=612x612&w=0&k=20&c=tfF_Mo65vGfjKPYolrPORSytd7uLwizKxih2YDNvXaI=" alt="Stag in the Mist"/>
                <div class="card-overlay">
                    <span class="caption">Stag in the Mist</span>
                    <span class="sub-caption">Majestic and mysterious</span>
                    <span class="view-icon"><i class="fa-solid fa-expand"></i></span>
                </div>
            </div>

            <!-- Gallery Card 4 - In the Glade -->
            <div class="gallery-card" data-bs-toggle="modal" data-bs-target="#photoModal" 
                 data-bs-img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK2VtHOOnDopPs78vRaS21YAzYs0OMCWHvGdEw-Gd8empOydxXkN5oxiPaqM0Q4LsuYP0&usqp=CAU"
                 data-bs-title="In the Glade"
                 data-bs-desc="A peaceful deer grazing in a sunlit glade"
                 data-bs-sub="Peaceful and serene"
                 data-bs-index="4"
                 data-bs-total="4">
                <img loading="lazy" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK2VtHOOnDopPs78vRaS21YAzYs0OMCWHvGdEw-Gd8empOydxXkN5oxiPaqM0Q4LsuYP0&usqp=CAU" alt="Deer in Glade"/>
                <div class="card-overlay">
                    <span class="caption">In the Glade</span>
                    <span class="sub-caption">Peaceful and serene</span>
                    <span class="view-icon"><i class="fa-solid fa-expand"></i></span>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <div class="modal-title-group">
                    ...
                    <div class="title-text">
                        <h5 id="modalTitle">Curious Fawn</h5>
                        <small id="modalDesc">A young deer fawn exploring its surroundings</small>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="image-wrapper">
                    <img id="modalImage" src="" alt="Deer" class="loaded"/>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        modal.addEventListener('show.bs.modal', function(event) {
            ...
            modalTitle.textContent = title || 'Deer';
