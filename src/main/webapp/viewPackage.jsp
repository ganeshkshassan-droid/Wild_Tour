...
<head>
    ...
    <style>
        /* Same base styles with purple theme */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .package-grid { padding: 40px 0 60px; }
        ...
        .package-card:hover .card-image { transform: scale(1.03); }
        .package-card .card-image-wrapper { position: relative; overflow: hidden; }
        ...
        .package-card .card-body .card-description {
            color: #6b7a6b;
            font-size: 0.92rem;
            line-height: 1.6;
            margin-bottom: 16px;
        ...
        .package-card .card-body .card-actions { display: flex; gap: 12px; }
        ...
        @media (max-width: 992px) {
            ...
            .package-grid .grid-wrapper { grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 24px; }
        }
        @media (max-width: 768px) {
            ...
            .package-grid .grid-wrapper { grid-template-columns: 1fr 1fr; gap: 16px; padding: 0 12px; }
            .package-card .card-body { padding: 18px; }
            .package-card .card-image { height: 180px; }
            .package-card .card-body h3 { font-size: 1.1rem; }
            .package-card .card-body .card-price { font-size: 1.1rem; }
            .package-card .card-body .card-actions .btn { font-size: 0.78rem; padding: 8px 12px; }
            .delete-modal { padding: 32px 24px 28px; }
            .delete-modal .modal-actions { flex-direction: column; }
        }
        @media (max-width: 576px) {
            .package-grid .grid-wrapper { grid-template-columns: 1fr; max-width: 400px; margin: 0 auto; }
...
<section class="page-header">
    <div class="container">
        <div class="header-content" data-aos="fade-up">
            ...
            <h1>Wildlife <span>Packages</span></h1>
        ...
        <div class="grid-wrapper" id="packageGrid">
                        ...
                        <div class="package-card" data-aos="fade-up" data-aos-delay="<%= (count % 4) * 100 + 100 %>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-actions">
                                    <a href="updatePackage.jsp?id=<%= id %>" class="btn btn-update">
                                        <i class="fa-regular fa-pen-to-square"></i> Update
                                    </a>
                                    <button type="button" class="btn btn-delete" 
                                            onclick="openDeleteModal(<%= id %>, '<%= name %>', 'package')">
            ...
            %>
                        <div class="empty-state">
                            ...
                            <a href="add_packages.jsp" class="btn-add">
...
<script>
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (deleteItemId && deleteItemType) {
            ...
            form.method = 'POST';
            form.action = deleteItemType === 'package' ? 'PackageAction' :
                          deleteItemType === 'safari' ? 'SafariAction' :
                          deleteItemType === 'stay' ? 'StayAction' : 'GuideAction';
            ...
            idInput.type = 'hidden';
            idInput.name = deleteItemType === 'package' ? 'packageId' :
                          deleteItemType === 'safari' ? 'safariId' :
                          deleteItemType === 'stay' ? 'stayId' : 'guideId';
