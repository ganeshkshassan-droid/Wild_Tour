...
<head>
    ...
    <title>Kabini Black Panther Gallery | Wildlife Tourism</title>
...
<section class="page-header">
    <div class="container">
        <div class="header-content" data-aos="fade-up">
            ...
            <h1>Kabini <span>Black Panther</span></h1>
...
<section class="hero-section">
    <div class="hero-content">
        ...
        <h1>The <span>Black Panther</span></h1>
        <p>Explore the elusive beauty of Kabini's majestic predator</p>
    </div>
...
<section class="gallery-section" id="gallery">
    <div class="container">
        <div class="section-header" data-aos="fade-up">
            ...
            <h2>Wildlife <span>Gallery</span></h2>
            <p>Explore the stunning collection of Black Panther photographs from Kabini</p>
        </div>

        <div class="gallery-grid">
            <!-- Gallery Card 1 -->
            <div class="gallery-card" data-bs-toggle="modal" data-bs-target="#photoModal" 
                 data-bs-img="https://im.whatshot.in/img/2020/Jul/is-2-1594273582.jpg"
                 data-bs-title="Forest Gaze"
                 data-bs-desc="The black panther captured in its natural habitat"
                 data-bs-sub="Kabini's majestic predator"
                 data-bs-index="1"
                 data-bs-total="4">
                <img loading="lazy" src="https://im.whatshot.in/img/2020/Jul/is-2-1594273582.jpg" alt="Black Panther in Forest"/>
                <div class="card-overlay">
                    <span class="caption">Forest Gaze</span>
            ...
            <!-- Gallery Card 2 -->
            <div class="gallery-card" data-bs-toggle="modal" data-bs-target="#photoModal" 
                 data-bs-img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtBbx-hy0SLATbCRAzuzGM2Cwm224P1Vq3DKQRrc4PH9Ep59MWEjZ7k74&s=10"
                 data-bs-title="Stealth in Shadows"
                 data-bs-desc="The panther moving silently through the shadows"
                 data-bs-sub="Silent and graceful"
                 data-bs-index="2"
                 data-bs-total="4">
                <img loading="lazy" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtBbx-hy0SLATbCRAzuzGM2Cwm224P1Vq3DKQRrc4PH9Ep59MWEjZ7k74&s=10" alt="Black Panther in Shadows"/>
                <div class="card-overlay">
                    <span class="caption">Stealth in Shadows</span>
                    <span class="sub-caption">Silent and graceful</span>
                    <span class="view-icon"><i class="fa-solid fa-expand"></i></span>
                </div>
            </div>
            ...
            <!-- Gallery Card 3 -->
            <div class="gallery-card" data-bs-toggle="modal" data-bs-target="#photoModal" 
                 data-bs-img="https://i.pinimg.com/736x/3e/91/0b/3e910bf5ca92ac1ebab74441c905bb86.jpg"
                 data-bs-title="Jungle Walk"
                 data-bs-desc="The panther walking through the dense forest"
                 data-bs-sub="Grace in motion"
                 data-bs-index="3"
                 data-bs-total="4">
                <img loading="lazy" src="https://i.pinimg.com/736x/3e/91/0b/3e910bf5ca92ac1ebab74441c905bb86.jpg" alt="Black Panther Walking"/>
                <div class="card-overlay">
                    <span class="caption">Jungle Walk</span>
                    <span class="sub-caption">Grace in motion</span>
                    <span class="view-icon"><i class="fa-solid fa-expand"></i></span>
                </div>
            </div>
            ...
            <!-- Gallery Card 4 -->
            <div class="gallery-card" data-bs-toggle="modal" data-bs-target="#photoModal" 
                 data-bs-img="https://im.whatshot.in/img/2020/Jul/is-1-1594273535.jpg"
                 data-bs-title="The Silent Prowler"
                 data-bs-desc="The panther on the prowl, watching its prey"
                ...
                <div class="card-overlay">
                    <span class="caption">The Silent Prowler</span>
...
<!-- ============================================
     ENHANCED PHOTO MODAL - FIXED ICONS
     ============================================ -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <div class="modal-title-group">
                    ...
                    <div class="title-text">
                        <h5 id="modalTitle">Forest Gaze</h5>
                        <small id="modalDesc">The black panther captured in its natural habitat</small>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <div class="image-wrapper">
                    <img id="modalImage" src="" alt="Black Panther" class="loaded"/>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        modal.addEventListener('show.bs.modal', function(event) {
            ...
            modalTitle.textContent = title || 'Black Panther';
