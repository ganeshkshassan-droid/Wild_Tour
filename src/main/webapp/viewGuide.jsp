...
<head>
    ...
    <style>
        /* Same base styles with amber theme */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .guide-grid { padding: 40px 0 60px; }
        ...
        .guide-card .card-image-wrapper { position: relative; padding-top: 20px; }
        ...
        .guide-card .card-body { padding: 20px 24px 24px; }
        ...
        .guide-card .card-body .card-actions { display: flex; gap: 12px; }
        ...
        @media (max-width: 992px) {
            ...
            .guide-grid .grid-wrapper { grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 24px; }
        }
        @media (max-width: 768px) {
            ...
            .guide-grid .grid-wrapper { grid-template-columns: 1fr 1fr; gap: 16px; padding: 0 12px; }
            .guide-card .card-body { padding: 16px; }
            .guide-card .card-image { width: 100px; height: 100px; }
            .guide-card .card-body h3 { font-size: 1.1rem; }
            .guide-card .card-body .card-price .amount { font-size: 1.2rem; }
            .guide-card .card-body .card-actions .btn { font-size: 0.75rem; padding: 8px 12px; }
            .delete-modal { padding: 32px 24px 28px; }
            .delete-modal .modal-actions { flex-direction: column; }
        }
        @media (max-width: 576px) {
            .guide-grid .grid-wrapper { grid-template-columns: 1fr; max-width: 360px; margin: 0 auto; }
            .stats-bar .stats-wrapper { gap: 20px; }
            .stats-bar .stat-item .stat-number { font-size: 1.4rem; }
            .page-header h1 { font-size: 1.5rem; }
            .page-header p { font-size: 0.9rem; }
            .guide-card .card-image { width: 120px; height: 120px; }
...
<section class="page-header">
    <div class="container">
        <div class="header-content" data-aos="fade-up">
            <span class="header-badge"><i class="fa-solid fa-compass"></i> Expert Guides</span>
            <h1>Wildlife <span>Guide</span> Services</h1>
        ...
        <div class="grid-wrapper" id="guideGrid">
                        ...
                        <div class="guide-card" data-aos="fade-up" data-aos-delay="<%= (count % 4) * 100 + 100 %>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-actions">
                                    <a href="updateGuide.jsp?id=<%= id %>" class="btn btn-update">
            ...
            %>
                        <div class="empty-state">
                            ...
                            <p>Start by adding your first wildlife guide.</p>
                            <a href="add_guide.jsp" class="btn-add">
...
<script>
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (deleteItemId && deleteItemType) {
            ...
            form.method = 'POST';
            form.action = deleteItemType === 'guide' ? 'GuideAction' :
                          deleteItemType === 'safari' ? 'SafariAction' :
                          deleteItemType === 'stay' ? 'StayAction' : 'PackageAction';
            ...
            idInput.type = 'hidden';
            idInput.name = deleteItemType === 'guide' ? 'guideId' :
                          deleteItemType === 'safari' ? 'safariId' :
                          deleteItemType === 'stay' ? 'stayId' : 'packageId';
