...
<html>
<head>
    <title>Update Package | Wildlife Tourism</title>
...
<div class="form-wrapper" data-aos="fade-up">
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p>Update the tour package details</p>
        </div>
        ...
        <form action="PackageAction" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" 
                       value="<%= pack.getName() %>" required>
                <div class="current-value"><i class="fa-regular fa-pen-to-square"></i> Current: <%= pack.getName() %></div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="image_url" id="image_url" class="form-control" 
                       value="<%= pack.getImage_url() %>" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="price" id="price" class="form-control" 
                       value="<%= pack.getPrice() %>" required>
                <div class="current-value"><i class="fa-regular fa-currency-sign"></i> Current: ₹<%= pack.getPrice() %></div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" 
                          rows="4"><%= pack.getDescription() %></textarea>
            ...
            <div class="btn-group-wrapper">
                ...
                <a href="viewPackage.jsp" class="btn btn-back">
