...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ----- Safari Grid ----- */
        .safari-grid { padding: 40px 0 60px; }
        ...
        .safari-card:hover .card-image { transform: scale(1.03); }
        .safari-card .card-image-wrapper { position: relative; overflow: hidden; }
        ...
        .safari-card .card-body { padding: 24px; }
        ...
        .safari-card .card-body .card-actions { display: flex; gap: 12px; }
        ...
        @media (max-width: 992px) {
            ...
            .safari-grid .grid-wrapper { grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 24px; }
        }
        @media (max-width: 768px) {
            ...
            .safari-grid .grid-wrapper { grid-template-columns: 1fr 1fr; gap: 16px; padding: 0 12px; }
            .safari-card .card-body { padding: 18px; }
            .safari-card .card-image { height: 180px; }
            .safari-card .card-body h3 { font-size: 1.1rem; }
            .safari-card .card-body .card-price .amount { font-size: 1.3rem; }
            .safari-card .card-body .card-actions .btn { font-size: 0.78rem; padding: 8px 12px; }
            .delete-modal { padding: 32px 24px 28px; }
            .delete-modal .modal-actions { flex-direction: column; }
        }
        @media (max-width: 576px) {
            .safari-grid .grid-wrapper { grid-template-columns: 1fr; max-width: 400px; margin: 0 auto; }
            .safari-card .card-image { height: 200px; }
...
<section class="page-header">
    <div class="container">
        <div class="header-content" data-aos="fade-up">
            ...
            <h1>Wildlife <span>Safari</span> Services</h1>
            <p>Explore our curated safari experiences in the wild</p>
        </div>
    </div>
</section>
        ...
        <div class="grid-wrapper" id="safariGrid">
                        ...
                        <div class="safari-card" data-aos="fade-up" data-aos-delay="<%= (count % 4) * 100 + 100 %>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-actions">
                                    <a href="updateSafari.jsp?id=<%= id %>" class="btn btn-update">
            ...
            %>
                        <div class="empty-state">
                            ...
                            <h3>No Safaris Found</h3>
                            <p>Start by adding your first safari experience.</p>
                            <a href="addsafari.jsp" class="btn-add">
...
<script>
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (deleteItemId && deleteItemType) {
            ...
            if (deleteItemType === 'safari') {
                form.action = 'SafariAction';
            } else if (deleteItemType === 'stay') {
                form.action = 'StayAction';
            } else if (deleteItemType === 'package') {
                form.action = 'PackageAction';
            } else if (deleteItemType === 'guide') {
            ...
            idInput.type = 'hidden';
            if (deleteItemType === 'safari') {
                idInput.name = 'safariId';
            } else if (deleteItemType === 'stay') {
                idInput.name = 'stayId';
            } else if (deleteItemType === 'package') {
                idInput.name = 'packageId';
            } else if (deleteItemType === 'guide') {
                idInput.name = 'guideId';
            }
