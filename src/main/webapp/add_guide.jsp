...
<html>
<head>
    <title>Add Guide | Wildlife Tourism</title>
...
<div class="form-wrapper" data-aos="fade-up">
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <h2>Add New <span>Guide</span></h2>
            <p>Fill in the details to add a new tour guide</p>
        </div>
        ...
        <form action="GuideAction" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="image" id="image" class="form-control" 
                       placeholder="https://example.com/guide-image.jpg" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="price" id="price" 
                       class="form-control" placeholder="Enter guide price" required>
            </div>

            <!-- Bio -->
            <div class="form-group">
                <label for="bio">
                    <i class="fa-regular fa-file-lines"></i> Bio (optional)
                </label>
                <textarea name="bio" id="bio" class="form-control" 
                          rows="4" placeholder="Enter guide bio or experience..."></textarea>
            </div>
