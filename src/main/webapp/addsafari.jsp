...
<html>
<head>
    <title>Add Safari | Wildlife Tourism</title>
...
<div class="form-wrapper" data-aos="fade-up">
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <h2>Add New <span>Safari</span></h2>
            <p>Fill in the details to add a new safari experience</p>
        </div>
        ...
        <form action="SafariAction" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" 
                       placeholder="Enter safari name" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="price_per_seat" id="price_per_seat" 
                       class="form-control" placeholder="Enter price per seat" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" 
                          rows="4" placeholder="Enter safari description here..."></textarea>
            </div>
