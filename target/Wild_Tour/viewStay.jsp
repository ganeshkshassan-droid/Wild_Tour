    ...
    <style>
        * {
        ...
        .page-header::before {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 30% 50%, rgba(37, 99, 235, 0.08) 0%, transparent 60%),
    ...
    <div class="container">
        ...
        <div class="stats-wrapper">
            ...
            <div class="stat-item">
                ...
                <div class="stat-number" id="totalStays">
                    0
                </div>
...
<%
    ...
    try {
         ...
         * IMPORTANT:
         *
         * Do NOT connect to localhost here.
         *
         * Connector.java handles the database
         * connection for both local development
         * and Render/Aiven deployment.
         */
        ...
        String sql =
            "SELECT stay_id, name, description, price_per_night, image_url FROM stay";
        ...
        while (rs.next()) {
            ...
            if (
                ...
                image =
                    "https://placehold.co/600x400/1a2e1a/ffffff?text=Accommodation";
...
>
    ...
    <div class="delete-modal">
        ...
        <p style="font-size:0.85rem; color:#6b7a6b;">
