...
<html>
<head>
    <title>Update Guide | Wildlife Tourism</title>
...
<div class="form-wrapper" data-aos="fade-up">
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <h2>Update <span>Guide</span></h2>
            <p>Update the guide profile details</p>
        </div>
        ...
        <form action="GuideAction" method="post">
            ...
            <div class="form-group">
                <label for="name">
                    <i class="fa-solid fa-user"></i> Guide Name <span class="required">*</span>
                </label>
                <input type="text" name="name" id="name" class="form-control" 
                       value="<%= guide.getName() %>" required>
                <div class="current-value"><i class="fa-regular fa-pen-to-square"></i> Current: <%= guide.getName() %></div>
            </div>
            ...
            <div class="form-group">
                <label for="bio">
                    <i class="fa-regular fa-file-lines"></i> Bio <span class="required">*</span>
                </label>
                <input type="text" name="bio" id="bio" class="form-control" 
                       value="<%= guide.getBio() %>" required>
                <div class="current-value"><i class="fa-regular fa-pen-to-square"></i> Current bio</div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="price" id="price" class="form-control" 
                       value="<%= guide.getPrice() %>" required>
                <div class="current-value"><i class="fa-regular fa-currency-sign"></i> Current: ₹<%= guide.getPrice() %></div>
            </div>

            <!-- Buttons -->
            <div class="btn-group-wrapper">
                <button type="submit" class="btn btn-submit">
                    <i class="fa-solid fa-floppy-disk"></i> Update Guide
                </button>
                <a href="viewGuide.jsp" class="btn btn-back">
