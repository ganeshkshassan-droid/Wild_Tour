...
<html>
<head>
    <title>Add Stay | Wildlife Tourism</title>
...
<div class="form-wrapper" data-aos="fade-up">
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <h2>Add New <span>Stay</span></h2>
            <p>Fill in the details to add a new accommodation option</p>
        </div>
        ...
        <form action="StayAction" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" 
                       placeholder="Enter stay name" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="price_per_night" id="price_per_night" 
                       class="form-control" placeholder="Enter price per night" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" 
                          rows="4" placeholder="Enter stay description here..."></textarea>
            </div>
